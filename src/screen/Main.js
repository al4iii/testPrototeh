        ...
        {dataDisplayed.length ? (
          <View style={{marginVertical: 16, marginTop: 40}}>
            <View
              ...
              <Text>
                {`page ${curPage + 1}/${Math.ceil(
                  dataDisplayed.length / pageRangeDisplayed,
                )}`}
              </Text>
            </View>
            {dataDisplayed.length / pageRangeDisplayed > 1 && (
              <View
                ...
                <PaginationDot
                  curPage={curPage}
                  maxPage={
                    Math.ceil(dataDisplayed.length / pageRangeDisplayed) - 1
                  }
                  sizeRatio={1.8}
            ...
            <View style={{marginTop: 16}}>
              <FlatList
                data={dataDisplayed.slice(
                  curPage * pageRangeDisplayed,
                  curPage * pageRangeDisplayed + pageRangeDisplayed,
                )}
